      ...
      <main className="flex-1">
          ...
          >
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-lg md:text-xl text-zinc-200">
                Join our cutting-edge AMS and unlock a world of opportunities for your institution and alumni.
              </p>
            </div>
          </motion.div>
        </section>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {[
                { title: "Free", price: "RS 0", description: "For 45 days only", features: ["Up to 1,000 alumni", "Basic networking features", "Event management"] },
                { title: "Standard", price: "RS 6,000", description: "For medium-sized institutions", features: ["Up to 5,000 alumni", "Advanced networking features", "Job board", "Mentorship program"] },
                { title: "Premium", price: "RS 10,000", description: "For large institutions", features: ["Unlimited alumni", "All Standard features", "Custom branding",  "Dedicated support"] },
              ].map((plan, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
